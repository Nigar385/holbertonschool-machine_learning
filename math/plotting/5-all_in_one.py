#!/usr/bin/env python3
"""
This module provides a function to compile the 5 previous plotting tasks
into a single 3x2 grid figure using matplotlib.
"""
import numpy as np
...
def all_in_one():
    """
    Plots a 3x2 grid of subplots containing line plots, scatter plots,
    logarithmic scales, combined curves, and a custom spanned histogram.
    """
    y0 = np.arange(0, 11) ** 3
    ...
    # Initialize the main figure size and layout
    ...
    # ---- Plot 4: Frequency (Spans 2 columns) ----
    ...
    # Automatically optimize subplot padding
    plt.tight_layout()
    plt.show()
